...
My OS of choice is [ Antix Linux ](https://antixlinux.com/) but this guide is also tailored for [ Ubuntu ](https://ubuntu.com/) and [ Debian ](https://www.debian.org/) users
...
2. ### Oh My Fish
    First install Fish Shell. [ official download instructions ](https://fishshell.com/)
    <Tabs>
      <TabItem label="Debian 13">
        ```shell 
    ...
    then install the [Oh My fish](https://github.com/oh-my-fish/oh-my-fish) framework for the Fish Shell

    ```shell 
    curl https://raw.githubusercontent.com/oh-my-fish/oh-my-fish/master/bin/install | fish
    ```
    also set the omf theme to [ batman ](https://github.com/oh-my-fish/theme-batman)
    ```sh
    omf install batman
    ```
3. ### Zoxide
    Install a smarter cd command alternative. [zoxide](https://github.com/ajeetdsouza/zoxide) for fish shell
...
- Debian ([Fish](https://fishshell.com/)) Based Steps
